...
This is test. Note that $S^n := \{ x \in \R^{n+1} \midbar \| x \| = 1 \}$.
...
\begin{text-box}
    1) This is test. Note that $S^n := \{ x \in \R^{n+1} \midbar \| x \| = 1 \}$.

    2) This is test. Note that $S^n := \{ x \in \R^{n+1} \midbar \| x \| = 1 \}$. \\
    3) This is test. Note that $S^n := \{ x \in \R^{n+1} \midbar \| x \| = 1 \}$.

    \begin{equation}
        ax + by = c
    \end{equation}
    
    4) This is test. Note that $S^n := \{ x \in \R^{n+1} \midbar \| x \| = 1 \}$.
\end{text-box}
